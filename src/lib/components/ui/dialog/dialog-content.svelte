...
<Dialog.Portal>
  <Dialog.Overlay />
  <DialogPrimitive.Content {transition} {transitionConfig} class={cn("fixed left-[50%] top-[50%] z-50 grid w-full max-w-4xl translate-x-[-50%] translate-y-[-50%] gap-4 border-2 border-[#273341] p-6 shadow-lg transition-all duration-500 dark:border-[#3b548c] sm:rounded-xl md:w-full", className)} {...rest}>
    {@render children?.()}
