<script lang="ts">
  ...
  export const playlists = ["Recently Added", "Recently Played", "Top Songs", "Top Albums", "Top Artists", "Logic Discography", "Bedtime Beats", "Feeling Happy", "I miss Y2K Pop", "Runtober", "Mellow Days", "Eminem Essentials"];
</script>

{#snippet sidebar()}
  <div class="flex flex-col gap-2 py-2">
    <h2 class="space-between flex items-center gap-2 rounded-lg bg-black p-1.5 pl-4 text-sm font-bold text-zinc-400">
